...
#Variables para que se visualicen los puntos y las líneas en las manos
mp_drawing = mp.solutions.drawing_utils
mp_hands = mp.solutions.hands

#Variables para que el videoCapture salga en pantalla
...
#funcion que calcula la distancia de los puntos que estan en los dedos
def calculate_distance(x1, y1, x2, y2):
    p1 = np.array([x1, y1])
    p2 = np.array([x2, y2])
    return np.linalg.norm(p1 - p2)

#funcion para calcular los puntos de referencia de las bases y añadirles color
...
with mp_hands.Hands(
    ...
    while True:
        ...
        #Metodo para controlar la pantalla 
